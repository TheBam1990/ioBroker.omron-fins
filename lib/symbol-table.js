...
/** @typedef {{name: string, value: string, type: string, write?: boolean, source?: string}} PlcVariable */
 ...
 * @returns {PlcVariable[]} Imported devices
 */
 ...
 *
 * @param {PlcVariable[]} manual Manual devices
 * @param {PlcVariable[]} imported Imported devices
 * @returns {PlcVariable[]} Merged devices
 */
